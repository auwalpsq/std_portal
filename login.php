...
<head>
	<meta charset="utf-8" />
	<title>Alumni Portal | Login Page</title>
...
// 	include 'modal/modal_ticket.php';
    ...
    <div class="brand text-inverse">
        <span class="" ></span>NOUN-Alumni Portal
        <small class="text-inverse"> Alumni Information Management system (AIMS) </small>
						</div>
						<div class="icon">
                ...
                <div class="login-content" >
                    <form  method="POST" id="frm" enctype="multipart/form-data" >
                        ...
                        <div class="m-t-20 m-b-20 p-b-10 text-inverse">
                            <p>Don't have an account yet? Click <a href="check" class="text-success">register</a> to verify and create an account.</p>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        try {
                            ...
                            var page = res.checkStatus === 'C' ? 'student_info' : 'form';  // set based on the category type
                            
                            var redirectUrl = isNounEmail ? 'udash' : page;  // Redirect based on the email type
